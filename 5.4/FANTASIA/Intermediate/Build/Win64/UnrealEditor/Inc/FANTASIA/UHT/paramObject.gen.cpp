...
template<> FANTASIA_API UScriptStruct* StaticStruct<FparamValues>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_ynapa_Documents_Unreal_Projects_A2F_Plugin_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ynapa_Documents_Unreal_Projects_A2F_Plugin_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ynapa_Documents_Unreal_Projects_A2F_Plugin_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_1091600341(TEXT("/Script/FANTASIA"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_ynapa_Documents_Unreal_Projects_A2F_Plugin_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ynapa_Documents_Unreal_Projects_A2F_Plugin_Plugins_FANTASIA_Source_FANTASIA_Public_paramObject_h_Statics::ScriptStructInfo),
		nullptr, 0);
